-- Update rpc_migraine_stats function to exclude pain_level '0' from average calculation
-- Only entries with pain_level != '0' should be included in the average intensity
