...
describe('AnalysisHistoryList.classifyEntry', () => {
  ...
  it('returns "version_drift" when range matches but version differs', () => {
    const e = entry({ dataStateSignature: 'v:2.1.0|pe:5:1|ve:0:0|mi:0:0|me:0:0|cn:0:0' });
    expect(classifyEntry(e, '2026-02-19', '2026-05-19', 'v:2.2.0|pe:5:1|ve:0:0|mi:0:0|me:0:0|cn:0:0')).toBe('version_drift');
  });

  it('returns "data_drift" when range and version match but data signature differs', () => {
    const e = entry();
