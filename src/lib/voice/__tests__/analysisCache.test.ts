...
describe('canReanalyze', () => {
  const baseCached: CachedAnalysis = {
    ...
    result: {
      ...
      openQuestions: [],
      confidenceNotes: [],
      scope: { daysAnalyzed: 30, painEntryCount: 10, voiceEventCount: 5 },
      meta: { model: 'test', analyzedAt: new Date().toISOString(), tokensUsed: 100, fromDate: '2026-01-01', toDate: '2026-03-31' },
    },
