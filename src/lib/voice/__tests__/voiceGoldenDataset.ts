...
export const GOLDEN_DATASET: GoldenCase[] = [
  ...
  { id: 'K5-17', classTag: 'K5', transcript: 'halb drei nachmittags Kopfschmerzen Stärke 7', expected: { pain: { value: 7 }, time: { kind: 'absolute' }, entry_type: 'new_entry', notes: { canBeEmpty: true } } },
  ...
  { id: 'K6-17', classTag: 'K6', transcript: 'starker Wind heute', expected: { pain: { value: null }, entry_type: 'context_entry', notes: { canBeEmpty: true } } },
  ...
  { id: 'K9-07', classTag: 'K9', transcript: 'also äh wenig geschlafen und dann Stress', expected: { pain: { value: null }, entry_type: 'new_entry', notes: { mustContain: ['geschlafen'] } } },
  { id: 'K9-08', classTag: 'K9', transcript: 'glaube ich habe so Stärke 6 oder 7 Kopfschmerzen', expected: { pain: { value: 6 }, entry_type: 'new_entry', notes: { canBeEmpty: true } } },
  ...
  { id: 'K9-10', classTag: 'K9', transcript: 'bitte Sumatriptan und starke Kopfschmerzen notieren', expected: { pain: { value: 7, isEstimated: true }, medications: ['Sumatriptan'], entry_type: 'new_entry', notes: { canBeEmpty: true } } },
  ...
  { id: 'K10-02', classTag: 'K10', transcript: 'kein Medikament genommen', expected: { pain: { value: null }, medications: [], entry_type: 'context_entry', notes: { canBeEmpty: true } } },
  ...
  { id: 'K10-05', classTag: 'K10', transcript: 'Migräne aber kein Medikament', expected: { pain: { value: 0 }, medications: [], entry_type: 'new_entry', notes: { canBeEmpty: true } } },
  ...
  { id: 'K10-08', classTag: 'K10', transcript: 'schmerzfrei seit gestern', expected: { pain: { value: null }, entry_type: 'context_entry', notes: { canBeEmpty: true } } },
  ...
  { id: 'K10-13', classTag: 'K10', transcript: 'kein Triptan genommen', expected: { pain: { value: null }, medications: [], entry_type: 'context_entry', notes: { canBeEmpty: true } } },
  ...
  { id: 'K10-15', classTag: 'K10', transcript: 'bin schmerzfrei', expected: { pain: { value: null }, entry_type: 'context_entry', notes: { canBeEmpty: true } } },
  ...
  { id: 'K10-20', classTag: 'K10', transcript: 'kein Anfall heute', expected: { pain: { value: 0 }, entry_type: 'new_entry', notes: { mustBeEmpty: true } } },
];
